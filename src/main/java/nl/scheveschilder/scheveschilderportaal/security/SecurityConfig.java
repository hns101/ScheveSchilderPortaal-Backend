    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/galleries/{email}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/galleries/{email}/artworks").permitAll()
                        .requestMatchers(HttpMethod.POST, "/galleries/{email}/artworks").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/galleries/{email}/artworks/{artworkId}").permitAll()
                        .requestMatchers(HttpMethod.POST, "/artworks/{id}/photo").permitAll()
                        .requestMatchers(HttpMethod.GET, "/artworks/{id}/photo").permitAll()
